...
path = '/opt/prometheus/exporters/dist/cloudera_exporter'
sym_path = '/opt/prometheus/exporters/cloudera_exporter_current'


def test_config_file(host):
    file = host.file('{}/config.ini'.format(path))
...
def test_exporter_symlink(host):
    file = host.file('/opt/prometheus/exporters/cloudera_exporter_current')
...
def test_exporter_installed(host):
    file_name = '{}/cloudera_exporter'.format(sym_path)
...
def test_exporter_is_running(host):
    s_name = 'prometheus-cloudera-exporter.service'
